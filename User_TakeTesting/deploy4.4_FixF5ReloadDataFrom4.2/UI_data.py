...
def sync_data(button):
    drive_file_url = "https://docs.google.com/spreadsheets/d/1t5RURrOdY6WF2xSCGzKEYyj22RXJZPanXgIBo-mAuYE/export?format=xlsx"
    ...
    try:
        ...
        return f"Lỗi khi sao chép file: {str(e)}"
    except OSError as e:
...
with gr.Blocks(theme=gr.themes.Soft()) as demo:
    ...
    gr.Button("Ấn vào đây => Chỉnh sửa trực tiếp `link google sheet`", link="https://docs.google.com/spreadsheets/d/1t5RURrOdY6WF2xSCGzKEYyj22RXJZPanXgIBo-mAuYE/edit")
...
demo.launch(server_name="0.0.0.0", server_port=25018)
